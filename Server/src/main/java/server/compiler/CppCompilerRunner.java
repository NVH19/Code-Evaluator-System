...
public class CppCompilerRunner {
    ...
    public void compileCppFile(String filePath) {
        try {
            ProcessBuilder processBuilder = new ProcessBuilder("g++", filePath, "-o", "compiled_program");
    ...
    public int runCppExecutable(String exerciseId, List<TestCase> testCases) {
        int successCount = 0;
        try {
            ...
            for (TestCase testCase : testCases) {
                ...
                ProcessBuilder processBuilder = new ProcessBuilder("./compiled_program");
